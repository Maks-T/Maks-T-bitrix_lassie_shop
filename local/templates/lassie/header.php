            ...
            <div class="header__contacts"><span class="header__icon icon-comment"></span>
                <div class="header__col header__col_contacts">
                    <div class="contacts"><a href="" class="contacts__tel"> <? $APPLICATION->IncludeComponent(
                          ...
                          array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => SITE_TEMPLATE_PATH . "/include/telephone1.php"
                          ),
                          false
                        ); ?></a>
                        <div class="contacts__info"><? $APPLICATION->IncludeComponent(
                            ...
                            array(
                              "AREA_FILE_SHOW" => "file",
                              "PATH" => SITE_TEMPLATE_PATH . "/include/schedule1.php"
                            ),
                            false
                          ); ?></div>
                    </div>
                ...
                <div class="header__col header__col_contacts">
                    <div class="contacts"><a href="" class="contacts__tel">
                        <? $APPLICATION->IncludeComponent(
                          ...
                          array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => SITE_TEMPLATE_PATH . "/include/telephone2.php"
                          ),
                          false
                        ); ?></a>
                        <div class="contacts__info"><? $APPLICATION->IncludeComponent(
                            ...
                            array(
                              "AREA_FILE_SHOW" => "file",
                              "PATH" => SITE_TEMPLATE_PATH . "/include/schedule2.php"
                            ),
                            false
                          ); ?></div>
                    </div>
