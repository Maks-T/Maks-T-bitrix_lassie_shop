				...
				case 'quantity':
					...
					elseif ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y')
					{
						if ($arParams['USE_PRODUCT_QUANTITY'])
						{
                          ...
                          <label for="good0-num" class="good__order-label"
                            >Количество</label
                          >
                          <div class="input-number">
                            ...
                            <div class="input-number__counter">
                              <span
                                class="input-number__counter-spin input-number__counter-spin_more"
                                >Больше</span
                              ><span
                                class="input-number__counter-spin input-number__counter-spin_less"
                                >Меньше</span
                              >
                            </div>
                          </div>
                          ...
                          <label for="<?=$itemIds['QUANTITY']?>" class="good__order-label"
                            >Количество</label
                          >
                          <div class="input-number">
                            <input
						...
						<div class="product-item-info-container product-item-hidden" id="<?=$itemIds['PROP_DIV']?>">
							...
							foreach ($arParams['SKU_PROPS'] as $skuProperty)
							{
								...
								?>
												...
												<form method="post" action="" class="form good__order" data-entity="sku-block">
												<ul class="good__order-row" data-entity="sku-line-block">
													<?
													foreach ($skuProperty['VALUES'] as $value)
													{
														...
														{
															?>
															<li class="checkbox-tile" title="<?=$value['NAME']?>" data-treevalue="<?=$propertyId?>_<?=$value['ID']?>" data-onevalue="<?=$value['ID']?>">
											    			<input id="<?=$item['ID'];?>_<?=$value['ID'];?>" name="Good[<?=$item['ID'];?>]" type="radio" value="<?=$value['NAME']?>" required class="checkbox-tile__elem" >
													    	<label for="<?=$item['ID'];?>_<?=$value['ID'];?>" class="checkbox-tile__label"><?=$value['NAME']?></label>
													  	</li>
