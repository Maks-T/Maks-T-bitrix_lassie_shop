                ...
                <div class="good__content">
                    <a id="<?= $arItemIDs['PICT']; ?>" href="<?= $arItem['DETAIL_PAGE_URL']; ?>"
                      ...
                      if ($arItem['LABEL']) {
                        ...
                        ?><span class="flag flag_type_<?= $arItem['LABEL_VALUE']; ?>"
                                title="<?= $arItem['LABEL_VALUE']; ?>"><?= $arItem['LABEL_VALUE']; ?></span><?
                      }
                    ...
                    <div class="good__price-wrapper"><?
                      if (!empty($arItem['MIN_PRICE'])) {
                        ...
                        if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) {
                          ?><span id="<?= $arItemIDs['DSC_PERC']; ?>"
                                  class="good__discount"
                          <?= (0 < $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT'] ? '' : 'style="display: none;"'); ?>
                            ><?= GetMessage('SB_MESS_DIFF_PERCENT',
                            ['#DIFF#' => $arItem['MIN_PRICE']['DISCOUNT_DIFF_PERCENT']]); ?></span><?
                        }
                      }
                      ?></div>
                </div>
                        ...
                        if ($arItem['CAN_BUY']) {
                          if ('Y' == $arParams['USE_PRODUCT_QUANTITY']) {
                            ?>
                              ...
                              <label for="<?= $arItemIDs['QUANTITY']; ?>" class="good__order-label">Количество</label>
                          ...
                          ?>
                            <button id="<?= $arItemIDs['BUY_LINK']; ?>" class="btn"><?
                          echo('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY'));
                          ?></button><?
                        } else {
                          ?><a class="link" href="<?= $arItem['DETAIL_PAGE_URL']; ?>" rel="nofollow"><?
                          ...
                          if ('Y' == $arParams['PRODUCT_SUBSCRIPTION'] && 'Y' == $arItem['CATALOG_SUBSCRIPTION']) {
                            ?>
                              <button id="<?= $arItemIDs['SUBSCRIBE_LINK']; ?>" class="btn"><?
...
<script type="text/javascript">
    BX.message({
        MESS_BTN_BUY: '<?=('' != $arParams['MESS_BTN_BUY'] ? CUtil::JSEscape($arParams['MESS_BTN_BUY']) : GetMessageJS('SB_TPL_MESS_BTN_BUY')); ?>',
        MESS_BTN_ADD_TO_BASKET: '<?=('' != $arParams['MESS_BTN_ADD_TO_BASKET'] ? CUtil::JSEscape($arParams['MESS_BTN_ADD_TO_BASKET']) : GetMessageJS('SB_TPL_MESS_BTN_ADD_TO_BASKET')); ?>',
        MESS_BTN_DETAIL: '<?=('' != $arParams['MESS_BTN_DETAIL'] ? CUtil::JSEscape($arParams['MESS_BTN_DETAIL']) : GetMessageJS('SB_TPL_MESS_BTN_DETAIL')); ?>',
        MESS_NOT_AVAILABLE: '<?=('' != $arParams['MESS_BTN_DETAIL'] ? CUtil::JSEscape($arParams['MESS_BTN_DETAIL']) : GetMessageJS('SB_TPL_MESS_BTN_DETAIL')); ?>',
        BTN_MESSAGE_BASKET_REDIRECT: '<?=GetMessageJS('SB_CATALOG_BTN_MESSAGE_BASKET_REDIRECT'); ?>',
        BASKET_URL: '<?=$arParams["BASKET_URL"]; ?>',
        ADD_TO_BASKET_OK: '<?=GetMessageJS('SB_ADD_TO_BASKET_OK'); ?>',
        TITLE_ERROR: '<?=GetMessageJS('SB_CATALOG_TITLE_ERROR') ?>',
        TITLE_BASKET_PROPS: '<?=GetMessageJS('SB_CATALOG_TITLE_BASKET_PROPS') ?>',
        TITLE_SUCCESSFUL: '<?=GetMessageJS('SB_ADD_TO_BASKET_OK'); ?>',
        BASKET_UNKNOWN_ERROR: '<?=GetMessageJS('SB_CATALOG_BASKET_UNKNOWN_ERROR') ?>',
        BTN_MESSAGE_SEND_PROPS: '<?=GetMessageJS('SB_CATALOG_BTN_MESSAGE_SEND_PROPS'); ?>',
        BTN_MESSAGE_CLOSE: '<?=GetMessageJS('SB_CATALOG_BTN_MESSAGE_CLOSE') ?>'
    });
</script>
