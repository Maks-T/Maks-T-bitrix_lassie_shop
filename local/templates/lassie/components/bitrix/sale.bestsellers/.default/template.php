                    ...
                    foreach ($arProp['VALUES'] as $arOneValue) {
                      ?>
                        <li data-treevalue="<? echo $arProp['ID'] . '_' . $arOneValue['ID']; ?>"
                            data-onevalue="<? echo $arOneValue['ID']; ?>" style="width: <? echo $strOneWidth; ?>;">
                ...
                <article class="good">
                    <div class="good__content">
                        <a href="javascript:void(0);" class="good__link">
                            <img src="<?= $arItem['PREVIEW_PICTURE_SECOND']['SRC'] ?>" alt="Товар" class="good__img"
                                 title=""><span class="flag flag_type_new">new</span>
                        </a><a href="javascript:void(0);" class="like">Мне нравится</a>
                        <h4 class="good__name"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                                                  title="<? echo $arItem['NAME']; ?>"><? echo $arItem['NAME']; ?></a>
                        </h4>
                        <div class="good__price-wrapper" id="<? echo $arItemIDs['PRICE']; ?> >
