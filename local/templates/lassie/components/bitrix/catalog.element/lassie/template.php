                ...
                <div class="card__top">
                  <? foreach ($arResult["OFFERS"] as $keyOffer => $offer): ?>
                    ...
                    ?>
                      ...
                      <div class="card__photos gallery" id="<?= $itemIds['SLIDER_CONT_OF_ID'] . $offer['ID'] ?>"
                           style="display: <?= $strVisible ?>;">
                          <div class="gallery__display">
                              <img src="<?= $offer["MORE_PHOTO"][0]["SRC"] ?>" style="width:570px; height:525px"
                          ...
                          <div class="gallery__thumbnails-container">
                              <ul class="gallery__thumbnails">
                                <? foreach ($offer['MORE_PHOTO'] as $key => $photo): ?>
                                    <li class="gallery__thumbnails-item" data-entity="image"
                                        data-value="<?= $offer['ID'] . '_' . $photo['ID'] ?>">
                                        <img class="gallery__thumbnails-img<?= $key === 0 ? " gallery__thumbnails-item_active" : "" ?>"
                                             src="<?= $photo['SRC'] ?>" )?>
                                    </li>
                                <?
                                endforeach
                  ...
                  ?>
                    <div class="card__info">
                        ...
                        <div class="card__content-block">
                          ...
                          <? if ($price["DISCOUNT"] > 0): ?>
                            <div id= <?= $itemIds["DISCOUNT_PERCENT_ID"] ?> class="card__discount text
                    ...
                    <div class="form" id="<?= $itemIds["TREE_ID"] ?>">
                      ...
                      endforeach ?>
                        ...
                        <div id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>">
                            <button id="<?= $itemIds['BUY_LINK'] ?>" data-popup="good"
