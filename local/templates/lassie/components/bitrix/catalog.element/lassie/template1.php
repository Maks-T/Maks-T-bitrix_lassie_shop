                      ...
                      <? foreach ($arResult["SKU_PROPS"] as $skuProperty): ?>
                        ...
                        <? if ($skuProperty["SHOW_MODE"] !== "PICT"): ?>
                              <div class="card__content-block" >
                                  ...
                                  <ul class="card__content-row card__content-row_checkboxes">
                                    <? foreach ($skuProperty["VALUES"] as & $value): ?>
                                      <? if ($value["NAME"] === '-') continue ?>
                                        <li class="checkbox-tile checkbox-tile_size_extra"
                                            title="<?= $value["NAME"] ?>"
                                            data-treevalue="<?= $propertyId ?>_<?= $value["ID"] ?>"
                                            data-onevalue="<?= $value["ID"] ?>">
                                            <input id="<?= $item["ID"] ?>_<?= $value["ID"] ?>"
                                                   name="Good[<?= $item["ID"] ?>]"
                                                   type="radio"
                                                   value="<?= $value["NAME"] ?>"
                                                   required class="checkbox-tile__elem">
                                            <label for="<?= $item["ID"] ?>_<?= $value["ID"] ?>"
                ...
                <div class="tabs__content-wrapper">
                    ...
                    <div data-tab='4' class="tabs__content">
                      ...
                      if ($arParams['USE_COMMENTS'] === 'Y')
                      {
                        ...
                        if (isset($arParams["USER_CONSENT"])) $componentCommentsParams["USER_CONSENT"] = $arParams["USER_CONSENT"];
                        if (isset($arParams["USER_CONSENT_ID"])) $componentCommentsParams["USER_CONSENT_ID"] = $arParams["USER_CONSENT_ID"];
                        if (isset($arParams["USER_CONSENT_IS_CHECKED"])) $componentCommentsParams["USER_CONSENT_IS_CHECKED"] = $arParams["USER_CONSENT_IS_CHECKED"];
                        if (isset($arParams["USER_CONSENT_IS_LOADED"])) $componentCommentsParams["USER_CONSENT_IS_LOADED"] = $arParams["USER_CONSENT_IS_LOADED"];
                        $APPLICATION->IncludeComponent('bitrix:catalog.comments', '', $componentCommentsParams, $component, array(
                          'HIDE_ICONS' => 'Y'
                        ));
                        ?>
                        <?php
